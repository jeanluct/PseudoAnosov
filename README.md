...
This package is an extension of the code used in papers by [Erwan Lanneau][1] and [Jean-Luc Thiffeault][2] to place bounds on the lowest dilatation on [closed surfaces][3] and [braids][4].  A minimal version was included as part of the braids paper as [PseudoAnosovLite](http://www.math.wisc.edu/~jeanluc/pubs/braids_mindil.zip).
